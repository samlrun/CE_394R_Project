...
<!-- use other words besides factor. Be very specific about what variables being used. -->
In order to determine the correlation between crash severity and manner of collision, pedestrian presence, etc...
...
<!-- not true -->
<!-- The results are very similar for intersections except the correlation factors are slightly higher in general. Table \@ref(tab:intManner) shows the correlations for intersections. -->
...
makeMannerTable(df,"Correlation Matrix for Crash Severity and Manner of Collision at Segments")
...
df <- read_csv("data/ISAM_Crashes_14-21.csv")
df <- corrManner(df,INT_ID)
makeMannerTable(df,"Correlation Matrix for Crash Severity and Manner of Collision at Intersections")
...
df <- read_csv("data/CAMS_Crashes_14-21_extra.csv")
df <- corrPed(df,SEG_ID)
makePedTable(df,"Correlation Matrix for Crash Severity and Pedestrain Variables at Segments")
...
df <- corrPed(df,INT_ID)
makePedTable(df,"Correlation Matrix for Crash Severity and Pedestrian Variables at Intersections")
